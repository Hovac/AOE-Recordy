#in the game, civs are tagged by numbers starting from 1. this list is ordered as is in the game, so when working with it, just add +1 to the index to get the civ name.
